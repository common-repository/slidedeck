		...
		$lensname=$pathinfo['filename'];
            ...
            <li class="template">
                <label>
                  ...
                  if (in_array("slidedeck5addon/slidedeck5addon.php", $active_plugins))
                    { ?>
                      <img src="<?php echo SLIDEDECK_URL .'../slidedeck5addon/slidedeck-templates/'.esc_attr( $template ).'/'.esc_attr( $lensname ).'.jpg' ?>" width="121px" />
                  <?php  }
                    else { ?>
                      <img src="<?php echo SLIDEDECK_URL .'../slidedeck-templates/'.esc_attr( $template ).'/'.esc_attr( $lensname ).'.jpg' ?>" width="121px" />
                  <?php  }
                    ?>
               ...
               <input type="radio" name="template" value="<?php echo esc_attr( $template ); ?>" />
                 <div class="lensname">
                    <?php
